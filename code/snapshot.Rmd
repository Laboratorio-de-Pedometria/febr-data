...
png(glue::glue("../res/{Sys.Date()}-febr-observacao.png"), width = 480 * 3, height = 480 * 3, res = 72 * 3)
plot(
...
```{r}
write.table(
  observacao, file = glue::glue("../data/{Sys.Date()}-febr-observacao.csv"), sep = ";", dec = ",", 
  row.names = FALSE)
```
...
write.table(
  febr, file = glue::glue("../data/{Sys.Date()}-febr-superconjunto.csv"), sep = ";", dec = ",", 
  row.names = FALSE)
```
