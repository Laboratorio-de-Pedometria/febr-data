...
# png("../res/fig/febr-observacao-espaco-goias.png", width = 480 * 2, height = 480 * 2, res = 72 * 2)
plot(
...
# png("../res/fig/febr-observacao-uf-saopaulo.png", width = 480 * 2, height = 480 * 2, res = 72 * 2)
...
# png("../res/fig/febr-observacao-sem-coordenadas-goias.png", width = 480 * 2, height = 480 * 2, res = 72 * 2)
layout(matrix(1:2, nrow = 1), widths = c(2, 2), heights = 1, respect = FALSE)
par(oma = c(0, 0, 1, 0), las = 1, mar = c(4, 4, 1, 1))
observacao %>% 
...
# png("../res/fig/febr-observacao-tempo-goias.png", width = 480 * 2, height = 480 * 2, res = 72 * 2)
