...
1. Fusão das colunas `taxon_sibcs_<...>` em uma única coluna `taxon_sibcs` usando `dplyr::coalesce()`, dando
   prioridade à classificação mais recente. Por enquanto, a classificação antiga (< 1999) é ignorada, pois a
   nomenclatura utilizada é muito diferente da nomenclatura atual. Nesse caso, observações apenas com a
...
Verificar distribuição espacial das observações com coordenadas espaciais.
...
observacao %>% 
  ...
  plot(
    cex = 0.5, colorkey = FALSE, col = "firebrick", axes = TRUE, 
