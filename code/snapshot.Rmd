...
```{r}
vars <- c("carbono", "argila", "areia", "silte", "terrafina", "cascalho", "calhaus", "dsi", "ctc", "ph", "ce")
camada <- febr::layer(
  dataset = "all",
...
camada %<>% 
  dplyr::mutate(
    ...
    cascalho = dplyr::coalesce(cascalho_peneira, cascalho_xxx),
    calhaus = dplyr::coalesce(calhaus_peneira, calhaus_xxx)
  )
```
