...
Primeiro, na falta de uma das três frações granulométricas finas -- `argila`, `silte` e `areia` --, calcula-se
seu valor como sendo a diferença entre 1000 g/kg e a soma das duas outras frações granulométricas. Isso é mais
comum no caso do silte. Na falta dos dados do conteúdo de areia total, primeiro se usa (quando disponível) os
dados do conteúdo de areia grossa + areia fina.
