...
camada %<>% 
  ...
  dplyr::mutate(
    profund.sup = correct_depth(profund.sup = profund_sup, profund.inf = profund_inf)$profund.sup,
    profund.inf = correct_depth(profund.sup = profund_sup, profund.inf = profund_inf)$profund.inf,
    profund_sup = profund.sup,
    profund_inf = profund.inf
  ) %>% 
  dplyr::ungroup()
```
...
camada %>% 
  ...
  dplyr::select(profund, carbono, argila, areia, silte, terrafina, dsi, ctc, ph, ce) %>% 
